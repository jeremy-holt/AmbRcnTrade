...
namespace Tests
{
    public class DraftBillLadingServiceTests : TestBaseContainer
    {
        ...
        public void LoadTemplate_ShouldLoadTheDraftBlTemplate()
        {
            ...
            // Act
            ExcelFile workbook = sut.LoadTemplate(MaerskDraftBlTemplateBlXlsx);
        ...
        public async Task LoadData_ShouldLoadTheVesselAndBillOfLadingAndCustomers()
        {
            ...
            // Act
            DraftBillLadingDataResponse response = await sut.LoadData(vessel.Id, billLading.Id);
        ...
        public async Task GetBillLadingCustomers_ShouldReturnBillLadingFormatCustomer()
        {
            ...
            BillLadingCustomers actual = sut.GetBillLadingCustomers(data);
        ...
        public async Task FillTemplate_ShouldFillTheTemplate()
        {
            ...
            // Act
            Action action = () => sut.FillTemplate(worksheet, response.Vessel.Id, response.BillLadingDto.Id);
            var actual =await sut.FillTemplate(worksheet, response.Vessel.Id, response.BillLadingDto.Id);
